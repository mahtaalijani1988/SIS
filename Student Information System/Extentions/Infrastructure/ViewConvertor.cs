...
using Student_Information_System.Controllers;
using StructureMap;
...
namespace Student_Information_System.Extentions.Infrastructure
{
    public class ViewConvertor : Controller, IViewConvertor
    {
        ...
        public string RenderRazorViewToString(string viewName, object model)
        {
            ...
            {
                var viewResult = ViewEngines.Engines.FindPartialView(CreateController<Student_Information_SystemController>().ControllerContext ,viewName);
                var viewContext = new ViewContext(CreateController<Student_Information_SystemController>().ControllerContext, viewResult.View,
